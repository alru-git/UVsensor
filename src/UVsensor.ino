 ...
 * Ver 1.0: Auf MSG 2 mir Radio ID 122 umgestellt
 * Ver 1.1: Umstellung auf MY_RADIO_RF24 (und testweise auf MSG1)
 * Ver 1.2: SLEEP_TIME verkürzt (und als Ganzzahl angegeben, nicht mehr als Produkt!), MSG2 gesetzt
 * Ver 1.3: uvText typo, SLEEPTime auf 5 Min. gesetzt
 * Ver 1.4: Messdaten werden auch gesendet, wenn sich der UV-Index nicht geändert hat
 */
...
void loop()
{
  ...
  // Messdaten versenden
  // Deaktiviert: Daten versenden, nur wenn sich der Index verändert hat
  //    if (uvIndex != lastUV) {
